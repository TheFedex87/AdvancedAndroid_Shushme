...
public class MainActivity extends AppCompatActivity implements
    ...
    private boolean isGeofenceSwitchEnabled;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Switch geofenceSwitch = (Switch)findViewById(R.id.enable_switch);
        isGeofenceSwitchEnabled = getPreferences(MODE_PRIVATE).getBoolean(getString(R.string.setting_enabled), false);
        geofenceSwitch.setChecked(isGeofenceSwitchEnabled);
